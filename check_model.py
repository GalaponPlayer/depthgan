...
def check_reconstruct_right(args):
    ...
    file_names = ['/home/kishida/depthgan/sample_kitti_obj/' + file_name for file_name in file_names]
    ...
    for filename in file_names:
        ...
        with torch.no_grad():
            ...
            save_path = os.path.join(output_dir, '{}_rec_{}{}.jpg'.format(output_name, model_name, ext))
